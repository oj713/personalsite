            ...
            <div className = "col-11 block background2">
                <div>
                    <div class="accent1-bg block d-flex justify-content-between pb-1">
                        ...
                        <div className = "vertcenter"><p>February 2022 - <i>Present</i></p></div>
                    </div>
                    <br/>
                    <div>
                ...
                <div>
                    <div class="accent1-bg block d-flex justify-content-between pb-1">
                        ...
                        <div className = "vertcenter"><p>April - August 2024</p></div>
                    </div>
                    <br/>
                    <div>
                ...
                <div>
                    <div class="accent1-bg block d-flex justify-content-between pb-1">
                        ...
                        <div className = "vertcenter"><p>August - December 2024</p></div>
                    </div>
                ...
                <div>
                    <div class="accent1-bg block d-flex justify-content-between pb-1">
                        ...
                        <div className = "vertcenter"><p>January - August 2023</p></div>
                    </div>
