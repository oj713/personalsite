    ...
    <div className = "mainPane sixtyeighty">
        ...
        <div className = "row mt-5">
            ...
            <div className = "col vertcenter">
                ...
                <a href="https://parkour-social-media-site.netlify.app/" target="_blank" rel="noopener noreferrer"><IoMdOpen className = "up yellowhover"/></a>
                <a href="https://github.com/oj713/parkour-frontend" target="_blank" rel="noopener noreferrer"><AiFillGithub className = "up yellowhover"/></a></h2>
                <p><i>Node.js, MongoDB, Bootstrap, Redux.js, React.js</i></p>
                <div className = "row">
                    <div className = "col-2"></div>
                    <div className = "block yellow-bg col">
        ...
        <div className = "row mt-5">
            ...
            <div className = "col-8 vertcenter">
                ...
                <a href="https://github.com/oj713/personalsite" target="_blank" rel="noopener noreferrer"><AiFillGithub className = "up orangehover"/></a></h2>
                <p><i>React.js, Bootstrap, HTML/CSS, Figma</i></p>
                <div className = "row">
                    <div className = "col-2"></div>
                    <div className = "block orange-bg col">
        ...
        <div className = "row mt-5">
            <div className = "col vertcenter">
                ...
                <a href="https://oj713.github.io/Web-Design/plant_watering/index.html" target="_blank" rel="noopener noreferrer"><IoMdOpen className = "up yellowhover"/></a>
                <a href="https://github.com/oj713/Web-Design/tree/main/plant_watering" target="_blank" rel="noopener noreferrer"><AiFillGithub className = "up yellowhover"/></a></h2>
        ...
        <div className = "row mt-5">
            ...
            <div className = "col vertcenter">
                ...
                <a href="https://oj713.github.io/Web-Design/google_doodle/index.html" target="_blank" rel="noopener noreferrer"><IoMdOpen className = "up orangehover"/></a>
                <a href="https://github.com/oj713/Web-Design/tree/main/google_doodle" target="_blank" rel="noopener noreferrer"><AiFillGithub className = "up orangehover"/></a></h2>
                <p><i>HTML/CSS</i></p>
                <div className = "row">
                    <div className = "col-2"></div>
                    <div className = "block orange-bg col">
